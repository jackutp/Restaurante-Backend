...
@Transactional
class ReservasServiceIntegrationTests {
	@Autowired
	...
	public void Repository_Save_ReturnSavePromotion(){
		ReservaRequestDTO reservaRequest = buildReservaRequest();
	...
	@Test
	public void shouldFindMesasById(){
		MesaRespuestaDto found = reservaReadService.findMesaById(3L);
		Assertions.assertThat(found).isNotNull();
	}
	@Test
	...
	@Test
	public void shouldReturnAllMesas(){
		List<MesaRespuestaDto> list = reservaReadService.findAllMesas();
		Assertions.assertThat(list).isNotEmpty();
	}
	@Test
