...
public class PdfGeneratorService {
    ...
    public String generarComprobantePdf(String tipo, String numeroCompleto,
        ...
        try {
            ...
            document.add(new Paragraph("Av. Javier Prado 1234 - Lima, Perú"));
            ...
            document.add(new Paragraph(" "));
            Paragraph gracias = new Paragraph("Gracias por su visita", new Font(Font.FontFamily.HELVETICA, 10, Font.ITALIC));
